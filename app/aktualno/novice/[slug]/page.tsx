      ...
      <main style={{ minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center", backgroundColor: "var(--section-bg)" }}>
        <div style={{ textAlign: "center", padding: "0 24px" }}>
          ...
          <h1 style={{ fontSize: "clamp(28px, 4vw, 42px)", fontWeight: 500, color: DARK, letterSpacing: "-0.025em" }}>
            Novica ni bila najdena
          </h1>
          <a href="/aktualno/novice" style={{ display: "inline-flex", alignItems: "center", gap: 8, marginTop: 28, color: GOLD, fontSize: 15, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", textDecoration: "none" }}>
            ← Nazaj na novice
          </a>
        </div>
      </main>
        ...
        <div style={{
          ...
          <nav style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 24, flexWrap: "wrap" }}>
            {[
              ...
              { label: "Novice", href: "/aktualno/novice" },
            ].map((crumb, i) => (
