  ...
  return (
    <main style={{ width: "100%", backgroundColor: "var(--section-bg)", overflowX: "hidden" }}>
      ...
      <section style={{ position: "relative", height: "100svh", minHeight: 540, overflow: "hidden" }}>
        {/*
          FIX: <Image priority> namesto <img>
          - priority = LCP element se naloži takoj
          - fill + sizes = pravilna velikost za full-screen
        */}
        <Image
          src="/honey.jpg"
        ...
        <div style={{
          ...
          background: "linear-gradient(to bottom, rgba(17,16,8,0.2) 0%, rgba(17,16,8,0.45) 60%, rgba(17,16,8,0.92) 100%)",
        }} />
        ...
        >
          ...
          >
            Čebelnjak<br />
            <span style={{ color: "rgb(221,204,171)" }}>na vrhu</span>
          </motion.h1>

          <motion.p
            initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.7 }}
            style={{ marginTop: 22, fontSize: 22, color: "rgba(255, 255, 255, 0.74)", maxWidth: 460, lineHeight: 1.75, fontFamily: "sans-serif" }}
          >
            ...
            {facts.map((f, i) => (
              <motion.div
                ...
                style={{
                  ...
                  background: CREAM, display: "flex", alignItems: "flex-start", gap: 16,
                }}
              >
